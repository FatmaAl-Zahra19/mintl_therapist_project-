...
import 'package:mintl555555555/features/user/Contact%20Us/ContactUSDone.dart';
    ...
    try {
      ...
      if (email != null) {
        await _firestore.collection('contacts').add({
          ...
          'userId': _user.uid, // Add the user's ID
        });
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => ContactUsIsDone()),
        );
      } else {
