...
class MyMoodTracker extends StatefulWidget {
  @override
  _MyMoodTrackerState createState() => _MyMoodTrackerState();
}

class _MyMoodTrackerState extends State<MyMoodTracker> {
        ...
        actions: <Widget>[
          ...
          Row(children: [
            ...
            IconButton(
              ...
              onPressed: () {
                                 Get.to(() => NavigationPage(), transition: Transition.fade);
