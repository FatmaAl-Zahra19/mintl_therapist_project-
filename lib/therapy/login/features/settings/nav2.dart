...
class NavigationPagethr2 extends StatefulWidget {
  @override
  _NavigationPagethr2State createState() => _NavigationPagethr2State();
}

class _NavigationPagethr2State extends State<NavigationPagethr2> {
